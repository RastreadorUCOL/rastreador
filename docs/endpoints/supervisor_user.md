...
## DELETE /api/supervisor-user/:id_supervisor/:id_user
- Rol: ADMIN
- Exito 200: { "message": "Asignacion removida exitosamente" }
- Errores: 404 no encontrada; 401/403 auth; 500 error.

## GET /api/supervisor-user/supervisor/:id_supervisor/users
...
## GET /api/supervisor-user/user/:id_user/supervisors
